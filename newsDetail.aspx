<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="newsDetail.aspx.cs" Inherits="newsDetail" %>
                        ...
                        <div class="elh-posts-listing">
                            <article class="elh-post style-4">
                                ...
                                <div class="elh-post-body">
                                    ...
                                    <h6 class="elh-post-title"> <asp:Label ID="lable_date" runat="server"  style="font-size:30px"></asp:Label></h6>
