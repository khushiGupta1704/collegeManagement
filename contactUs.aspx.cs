...
public partial class contactUs : System.Web.UI.Page
{
    ...
    protected void button_submit_Click(object sender, EventArgs e)
    {
        if (contactName.Text != "" && contactEmail.Text != "" && contactMessage.Text != "")
        {
            ...
            verma.Save_Data("insert into inquiry values ('" + contactName.Text + "','" + contactEmail.Text + "','" + inputPhone.Text + "','" + address.Text + "','" + courseSelect.Text + "','1','" + contactMessage.Text + "','" + DateTime.Now + "')");
