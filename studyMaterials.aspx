<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="studyMaterials.aspx.cs" Inherits="studyMaterials" %>
                                ...
                                <ItemTemplate>
                                    <tr>
                                      <%--<td>
                                        ...
                                        <td style="width:20%"><a href="studentStudyMaterial.aspx?session_id=<%#Eval("session_id")%>&course_id=<%#Eval("course_id")%>&type=<%#Eval("student_type")%>" class="btn">View</a> 
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
