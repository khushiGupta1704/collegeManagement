<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMasterPage.master" AutoEventWireup="true" CodeFile="chairmanMessage.aspx.cs" Inherits="chairmanMessage" %>
      ...
      <div class="elh-page-header elh-img-bg elh-bg-9">
        <div class="elh-overlay" style="padding-top: 35px;padding-bottom: 35px;">
            <div class="container text-center">
                <h3 class="elh-page-title">Chairman Messsage</h3>
                <ol class="breadcrumb">
                    <li><a href="index.aspx">Home</a></li>
                    <li class="active">Chairman Messsage</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="elh-section-header text-left" style="margin-bottom: 0px;style="margin-top: 0px"">
                            <h3 class="elh-section-title">Our  <span>Chairman Says</span></h3>
                         </div>
                    </div>
                </div>
                             <div class="row">
